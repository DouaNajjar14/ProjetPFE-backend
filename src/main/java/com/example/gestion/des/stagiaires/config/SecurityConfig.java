        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                // n8n webhook (sécurisé par header X-N8N-Token)
                                                .requestMatchers("/api/n8n/**").permitAll()
                                                // Confirmation directe depuis email (sans JWT)
                                                .requestMatchers("/api/admin/confirm-direct/**").permitAll()
                                                ...
                                                .hasAnyRole("ADMIN", "AGENT_RH")
                                                .requestMatchers(HttpMethod.GET, "/api/admin/encadrants",
                                                                "/api/admin/encadrants/**")
                                                .hasAnyRole("ADMIN", "AGENT_RH")
                                                .requestMatchers("/api/agent-rh/agents/**").hasRole("ADMIN")
